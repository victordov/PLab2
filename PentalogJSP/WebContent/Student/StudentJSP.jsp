...
function deleteRecord(id,path){
				...
				<td align="right" colspan="<%=studList.size()%>">
					<%
						out.print("<td rowspan = \""
								+ studList.size()
								+ "\"><a href=\""+request.getContextPath() +"/Student/insertStudentForm.jsp\"><input type=\"button\" name=\"insert\"");
	...
	<a href="<%=request.getContextPath()%>/studentxmldownloadservlet">Export to XML</a>
